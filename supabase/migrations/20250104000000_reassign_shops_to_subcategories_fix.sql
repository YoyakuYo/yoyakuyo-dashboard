-- ============================================================================
-- REASSIGN SHOPS TO SUBCATEGORIES - FIX
-- ============================================================================
-- This migration reassigns ALL shops from main categories to their specific
-- subcategories based on the shops.subcategory field
-- This ensures every subcategory has shops assigned
-- ============================================================================
...
BEGIN
    RAISE NOTICE '=== STARTING: Reassigning shops to subcategories ===';
    ...
    WHERE subcategory IN ('Aesthetic Clinic', 'Aesthetic')
    AND (SELECT id FROM categories WHERE name = 'Aesthetic Clinic') IS NOT NULL;
    GET DIAGNOSTICS shops_updated = ROW_COUNT;
    total_updated := total_updated + shops_updated;
    ...
    RAISE NOTICE '=== COMPLETE: Reassigned % total shops to subcategories ===', total_updated;
END $$;
...
WHERE c.name IN (
    ...
    'Dental Clinic', 'Eye Clinic', 'Women''s Clinic', 'Wellness Clinic', 'Aesthetic Clinic',
