-- ============================================
-- CONVERT ALL WEB CUSTOMERS TO GUEST AND REMOVE WEB ACCOUNTS
-- ============================================
-- This migration will:
-- 1. Create a guest customer account if none exists
-- 2. Reassign all web customer bookings to the guest account
-- 3. Reassign all web customer messages to the guest account
-- 4. Reassign all web customer threads to the guest account
-- 5. Reassign all web customer reviews to the guest account
-- 6. Delete all web customer accounts and related auth data
-- ============================================
...
BEGIN
    ...
    LOOP
        ...
        RAISE NOTICE '  Reassigned % conversation customer references', total_messages_reassigned;
...
-- COMPLETION NOTICE
-- ============================================
-- All web customers have been converted to guest customers.
-- All their bookings, messages, threads, and reviews have been reassigned.
-- Web customer accounts and authentication data have been removed.
-- ============================================