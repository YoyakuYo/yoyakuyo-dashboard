-- ============================================
-- SQL Migration: Create ai_conversations table
...
CREATE INDEX IF NOT EXISTS ai_conversations_shop_id_idx ON ai_conversations(shop_id) WHERE shop_id IS NOT NULL;
...
-- Guests can read/insert/update conversations
