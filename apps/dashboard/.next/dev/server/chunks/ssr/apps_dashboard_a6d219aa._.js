...
function Home() {
    ...
    const handleLoginSubmit = async (e)=>{
        ...
        try {
            const { error: signInError } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getSupabaseClient"])().auth.signInWithPassword({
                email: loginEmail,
...
//# sourceMappingURL=apps_dashboard_a6d219aa._.js.map