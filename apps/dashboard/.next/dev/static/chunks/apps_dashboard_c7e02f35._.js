...
}, "ExDREh/X1W5qj/rKrRvx9CNfQOI=", false, function() {
    return [
...
function useBookingNotificationsHook() {
    ...
    const subscribeToBookingUpdates = ()=>{
        ...
        const channel = supabase.channel('booking_notifications').on('postgres_changes', {
            ...
            if (oldBooking?.status === 'pending' && updatedBooking?.status !== 'pending') {
                ...
                if (shopIdsRef.current.length > 0 && shopIdsRef.current.includes(updatedBooking.shop_id)) {
                    setUnreadBookingsCount((prev)=>prev + 1);
                } else {
                    await reloadPendingCount();
                }
    ...
    const reloadPendingCount = async ()=>{
        if (!user?.id) return;
        try {
            const bookingsRes = await fetch(`${apiUrl}/bookings`, {
                headers: {
...
_s(useBookingNotificationsHook, "VEioTt1RdQRb1DfokMeLWYEqXQ8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$lib$2f$useAuth$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"],
...
//# sourceMappingURL=apps_dashboard_c7e02f35._.js.map