...
function NextIntlProviderWrapper({ children }) {
    ...
    const [messages, setMessages] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(defaultMessages); // Start with default messages
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
            ...
            const getStoredLocale = {
                "NextIntlProviderWrapper.useEffect.getStoredLocale": ()=>{
                    ...
                    const langCookie = cookies.find({
                        "NextIntlProviderWrapper.useEffect.getStoredLocale.langCookie": (c)=>c.trim().startsWith('bookyo_language=')
        ...
        "NextIntlProviderWrapper.useEffect": ()=>{
            const handleStorageChange = {
                "NextIntlProviderWrapper.useEffect.handleStorageChange": ()=>{
                    ...
                    const cookies = document.cookie.split(';');
                    const langCookie = cookies.find({
                        "NextIntlProviderWrapper.useEffect.handleStorageChange.langCookie": (c)=>c.trim().startsWith('bookyo_language=')
...
_s(NextIntlProviderWrapper, "HkSt3XcJHx4R4yxAXbFCOCrFxoQ=");
...
//# sourceMappingURL=apps_dashboard_de73bc74._.js.map