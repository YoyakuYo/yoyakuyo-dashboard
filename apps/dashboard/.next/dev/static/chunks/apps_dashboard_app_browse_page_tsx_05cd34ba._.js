...
function PublicShopsPageContent() {
    ...
    const [selectedCategoryId, setSelectedCategoryId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(searchParams.get('category_id') || null);
    const [selectedArea, setSelectedArea] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(searchParams.get('area') || null);
    ...
    const [expandedAreas, setExpandedAreas] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(new Set());
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PublicShopsPageContent.useEffect": ()=>{
            const timer = setTimeout({
                "PublicShopsPageContent.useEffect.timer": ()=>{
                    setDebouncedSearch(searchQuery);
                }
            }["PublicShopsPageContent.useEffect.timer"], 500);
            return ({
                "PublicShopsPageContent.useEffect": ()=>clearTimeout(timer)
            })["PublicShopsPageContent.useEffect"];
        }
    }["PublicShopsPageContent.useEffect"], [
        searchQuery
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PublicShopsPageContent.useEffect": ()=>{
            const fetchCategories = {
                "PublicShopsPageContent.useEffect.fetchCategories": async ()=>{
                    try {
            ...
            }["PublicShopsPageContent.useEffect.fetchCategories"];
            fetchCategories();
        }
    }["PublicShopsPageContent.useEffect"], [
        apiUrl
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PublicShopsPageContent.useEffect": ()=>{
            const fetchCategoryStats = {
                "PublicShopsPageContent.useEffect.fetchCategoryStats": async ()=>{
                    try {
            ...
            }["PublicShopsPageContent.useEffect.fetchCategoryStats"];
            fetchCategoryStats();
        }
    }["PublicShopsPageContent.useEffect"], [
        apiUrl
    ...
    const fetchShops = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "PublicShopsPageContent.useCallback[fetchShops]": async ()=>{
            try {
                setLoading(true);
                ...
                if (res.ok) {
                    ...
                    if (contentType && contentType.includes('application/json')) {
                        const data = await res.json();
                        const visibleShops = Array.isArray(data) ? data.filter({
                            "PublicShopsPageContent.useCallback[fetchShops]": (shop)=>!shop.claim_status || shop.claim_status !== 'hidden'
                        }["PublicShopsPageContent.useCallback[fetchShops]"]) : [];
    ...
    const groupedShops = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "PublicShopsPageContent.useMemo[groupedShops]": ()=>{
            const categoryMap = new Map();
            // Filter shops by selected area if any
            const filteredShops = selectedArea ? shops.filter({
                "PublicShopsPageContent.useMemo[groupedShops]": (shop)=>{
            ...
            }["PublicShopsPageContent.useMemo[groupedShops]"]) : shops;
            // Group by category, then by area
            filteredShops.forEach({
                "PublicShopsPageContent.useMemo[groupedShops]": (shop)=>{
            ...
            categoryMap.forEach({
                "PublicShopsPageContent.useMemo[groupedShops]": (areaMap, categoryId)=>{
                    ...
                    const areas = Array.from(areaMap.entries()).map({
                        "PublicShopsPageContent.useMemo[groupedShops].areas": ([areaKey, shops])=>({
                                areaName: getTranslatedAreaName(areaKey, t),
                                areaKey,
                                shops,
                                count: shops.length
                            })
                    }["PublicShopsPageContent.useMemo[groupedShops].areas"]).sort({
                        "PublicShopsPageContent.useMemo[groupedShops].areas": (a, b)=>b.count - a.count
                    }["PublicShopsPageContent.useMemo[groupedShops].areas"]); // Sort by count descending
                    const totalShops = areas.reduce({
                        "PublicShopsPageContent.useMemo[groupedShops].totalShops": (sum, area)=>sum + area.count
                    }["PublicShopsPageContent.useMemo[groupedShops].totalShops"], 0);
                    categoryGroups.push({
                        categoryId,
                        categoryName,
                        areas,
            ...
            categoryGroups.sort({
                "PublicShopsPageContent.useMemo[groupedShops]": (a, b)=>b.totalShops - a.totalShops
            }["PublicShopsPageContent.useMemo[groupedShops]"]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PublicShopsPageContent.useEffect": ()=>{
            ...
            groupedShops.forEach({
                "PublicShopsPageContent.useEffect": (group)=>{
    ...
    const displayShops = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "PublicShopsPageContent.useMemo[displayShops]": ()=>{
            if (selectedArea) {
                return shops.filter({
                    "PublicShopsPageContent.useMemo[displayShops]": (shop)=>{
                        const areaKey = extractAreaKey(shop.address);
                        const translatedName = getTranslatedAreaName(areaKey, t);
                        return translatedName === selectedArea || areaKey === selectedArea;
                    }
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("aside", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        selectedArea && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    displayShops.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        lineNumber: 554,
                        columnNumber: 13
                    }, this) : groupedShops.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "bg-white rounded-xl border border-gray-200 p-12 text-center",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "text-6xl mb-4",
                                ...
                                children: [
                                    ...
                                    isExpanded && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            !showAllAreas && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                onClick: ()=>{
...
_s(PublicShopsPageContent, "bYfUI1Rb9PNBxUdb7S6MTx2+RTI=", false, function() {
    return [
...
function PublicShopsPage() {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Suspense"], {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(PublicShopsPageContent, {}, void 0, false, {
            fileName: "[project]/apps/dashboard/app/browse/page.tsx",
            lineNumber: 705,
            columnNumber: 7
        }, this)
...
_s1(PublicShopsPage, "h6+q2O3NJKPY5uL0BIJGLIanww8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$intl$2f$dist$2f$esm$2f$development$2f$react$2d$client$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTranslations"]
    ];
});
_c1 = PublicShopsPage;
var _c, _c1;
__turbopack_context__.k.register(_c, "PublicShopsPageContent");
__turbopack_context__.k.register(_c1, "PublicShopsPage");
...
//# sourceMappingURL=apps_dashboard_app_browse_page_tsx_05cd34ba._.js.map