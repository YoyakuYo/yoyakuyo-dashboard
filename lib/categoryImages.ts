...
export function getCategoryImages(imageKey: string): string[] {
  return categoryMarketing[imageKey]?.images || categoryImages[imageKey] || [
    '/categories/beauty-salon.jpg', // Fallback to a default local image
  ];
}
