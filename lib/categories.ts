...
export const SUBCATEGORIES: Category[] = [
  ...
  // Spa, Onsen & Relaxation subcategories
  {
    ...
    isSubcategory: true,
    imageKey: 'spa',
    unsplashSearch: 'luxury japanese spa',
    imageVariations: [
      'luxury japanese spa',
      'japanese relaxation spa room',
  ...
  },
  {
    ...
    parentId: 'spa_onsen_relaxation',
    isSubcategory: true,
    imageKey: 'ryokan-onsen',
    unsplashSearch: 'japanese ryokan onsen',
    imageVariations: [
      'japanese ryokan onsen',
      'traditional japanese ryokan room',
      'ryokan tatami room japan',
      'ryokan with onsen bath',
      'japanese inn hot spring',
    ],
    dbName: 'Ryokan Onsen',
  },
  ...
  },
  {
    ...
    isSubcategory: true,
    imageKey: 'karaoke',
    unsplashSearch: 'japanese karaoke room',
    imageVariations: [
      'japanese karaoke room',
      'tokyo karaoke box interior',
      'modern japanese karaoke',
      'japanese private karaoke room',
      'tokyo karaoke bar',
    ],
    dbName: 'Karaoke',
  },
  ...
  },
  {
    ...
    isSubcategory: true,
    imageKey: 'pilates',
    unsplashSearch: 'japanese pilates studio',
    imageVariations: [
      'japanese pilates studio',
      'tokyo pilates class',
      'modern pilates studio japan',
      'japanese fitness studio',
      'pilates reformer japan',
    ],
    dbName: 'Pilates',
  },
  {
    ...
    isSubcategory: true,
    imageKey: 'yoga',
    unsplashSearch: 'japanese yoga studio',
    imageVariations: [
      'japanese yoga studio',
      'tokyo yoga class',
      'modern yoga studio japan',
      'japanese meditation yoga',
      'yoga mats japan',
    ],
    dbName: 'Yoga',
  },
